...
ALTER TABLE "customer_customer_demo" ADD FOREIGN KEY ("customer_id") REFERENCES "customers" ("customer_id");

ALTER TABLE "customer_customer_demo" ADD FOREIGN KEY ("customer_type_id") REFERENCES "customer_demographics" ("customer_type_id");

ALTER TABLE "employees" ADD FOREIGN KEY ("reports_to") REFERENCES "employees" ("employee_id");

ALTER TABLE "employee_territories" ADD FOREIGN KEY ("employee_id") REFERENCES "employees" ("employee_id");

ALTER TABLE "employee_territories" ADD FOREIGN KEY ("territory_id") REFERENCES "territories" ("territory_id");
...
ALTER TABLE "orders" ADD FOREIGN KEY ("ship_via") REFERENCES "shippers" ("shipper_id");

ALTER TABLE "products" ADD FOREIGN KEY ("supplier_id") REFERENCES "suppliers" ("supplier_id");

ALTER TABLE "products" ADD FOREIGN KEY ("category_id") REFERENCES "categories" ("category_id");

ALTER TABLE "territories" ADD FOREIGN KEY ("region_id") REFERENCES "region" ("region_id");
